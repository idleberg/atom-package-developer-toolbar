...
export const configSchema = {
	...
	browseTools: {
		...
		description:
			'Displays buttons to browse files and folders, e.g. `Config Folder`, `Packages Folder`, `Current File` etc.',
		type: 'boolean',
		default: true,
		order: 2,
	},
	...
	devTools: {
		...
		description:
			'Display buttons for useful developer features, e.g. `Console`, `Reload Window`, `Timecop`, `Package Specs` etc.',
		type: 'boolean',
		default: true,
		order: 4,
	},
